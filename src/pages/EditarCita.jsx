...
import FormularioEditarCita from "../componentes/FormularioEditarCita";
...
const EditarCita = () => {
  ...
  return (
    <>
      ...
      <div
        className="container mt-10 mx-auto h-[600px] md:h-[600px]  text-center rounded-[30px] shadow-md"
      ...
      >
        ...
        <nav className="mt-28 md:mt-32 flex justify-between">
          <Link
            to="/menu"
